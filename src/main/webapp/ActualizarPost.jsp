        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="container mt-2">
                    <div class="row">
                        <form action="PostsCTO?opc=actualizar&id=${id}&ahiru=${user.getId()}" method="POST" >
                            <div class="mb-3">
                                <label for="titulo" class="col-form-label">Titulo:</label>
                                <input class="form-control" type="text" name="titulo" placeholder="Titulo aqui" required="true" maxlength="70" value="${titulo}" autocomplete="off" autofocus="true"/>
                            </div>
                            <div class="mb-3">
                                <label for="contenido" class="col-form-label">Contenido</label>
                                <textarea class="form-control" name="contenido" placeholder="Contenido aqui" required="true" style="height: 300px" >${contenido}</textarea>
                            </div>
                            <div class="mb-3">
                                <label for="multimedia" class="col-form-label">Multimedia:</label>
                                <input class="form-control" type="text" name="multimedia" placeholder="Inserte link de Youtube" maxlength="70" value="${multimedia}" autocomplete="off"/>
                            </div>
